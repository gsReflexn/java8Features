...
public class BiFunctionExample implements BiFunction<List<Integer>,List<Integer>,List<Integer>> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Lambda approach without andThen: "+biFunction2.apply(list1, list2));

        System.out.println("Lambda approach with andThen: "+biFunction2.andThen(sortedFunction).apply(list1, list2));

        /**
         * why will below statement fail because
         * andThen returns a new BiFunction that applies the original function first and then applies the provided Function (in this case, sortedFunction) to the result.
         * When you subsequently call apply(list1, list2), the combined operation (original BiFunction + sortedFunction) is executed.
         *
         */

        //System.out.println("Lambda approach with andThen: "+biFunction2.apply(list1, list2).andThen(sortedFunction));
